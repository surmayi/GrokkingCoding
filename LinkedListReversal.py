...
def reverse_in_two_parts(head):
  ...
  if n%2==0:
    return reverse_sub_list(head,n//2+1,n)
  else:
    return reverse_sub_list(head,n//2+2,n)
...
def main():
  ...
  result = rever_first_k_elements(head,4)
  print("Nodes of reverse_first_k_elements LinkedList are: ", end='')
  result.print_list()
  ...
  result = rever_first_k_elements(head,2)
  print("Nodes of reverse_first_k_elements LinkedList are: ", end='')
  result.print_list()
